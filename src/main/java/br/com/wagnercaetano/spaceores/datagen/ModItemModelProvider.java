...
public class ModItemModelProvider extends ItemModelProvider {
    ...
    protected void registerModels() {
        simpleBlockItem(ModItems.GALACTITE);
        simpleBlockItem(ModItems.RAW_GALACTITE);
        simpleBlockItem(ModItems.METAL_DETECTOR);
        simpleBlockItem(ModItems.STRAWBERRY);
        simpleBlockItem(ModItems.PINE_CONE);

        simpleHandHeldItem(ModItems.GALACTITE_SWORD);
        simpleHandHeldItem(ModItems.GALACTITE_PICKAXE);
        simpleHandHeldItem(ModItems.GALACTITE_AXE);
        simpleHandHeldItem(ModItems.GALACTITE_SHOVEL);
        simpleHandHeldItem(ModItems.GALACTITE_HOE);

        trimmedArmorItem(ModItems.GALACTITE_HELMET);
        trimmedArmorItem(ModItems.GALACTITE_CHESTPLATE);
        trimmedArmorItem(ModItems.GALACTITE_LEGGINGS);
        trimmedArmorItem(ModItems.GALACTITE_BOOTS);
